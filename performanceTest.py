...
def benchmark():
    ...
    print('Test results: time: {time}s, perfTime: {perf}s, stability: {NumberOfSucess}/{ExeNumber}'.format(time=elapsedTime, perf=elapsedPerfTime, NumberOfSucess=NumberOfSucess, ExeNumber=NUMBER_OF_ALGORITM_EXECUTION))
